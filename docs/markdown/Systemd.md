...
Systemd 是 Linux 系统工具，用来启动[守护进程](./Linux守护进程的启动方法.md)，已成为大多数发行版的标准配置。

![img](https://cdn.jsdelivr.net/gh/zerobiubiu/Figure-bed/bg2016030701.gif)
...
![img](https://cdn.jsdelivr.net/gh/zerobiubiu/Figure-bed/bg2016030702.jpg)
...
![qqqqqssssss](https://cdn.jsdelivr.net/gh/zerobiubiu/Figure-bed/qqqqqssssss.png)

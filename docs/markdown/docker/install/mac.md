...
![](https://cdn.jsdelivr.net/gh/zerobiubiu/Figure-bed/202202172043952.png)

## 运行

从应用中找到 Docker 图标并点击运行。

![](https://cdn.jsdelivr.net/gh/zerobiubiu/Figure-bed/202202172043228.png)

运行之后，会在右上角菜单栏看到多了一个鲸鱼图标，这个图标表明了 Docker 的运行状态。

![](https://cdn.jsdelivr.net/gh/zerobiubiu/Figure-bed/202202172043755.png)

每次点击鲸鱼图标会弹出操作菜单。

![](https://cdn.jsdelivr.net/gh/zerobiubiu/Figure-bed/202202172043517.png)
...
![](https://cdn.jsdelivr.net/gh/zerobiubiu/Figure-bed/202202172043788.png)
